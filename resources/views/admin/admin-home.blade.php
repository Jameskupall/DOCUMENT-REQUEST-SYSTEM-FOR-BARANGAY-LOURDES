    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-8 w-full max-w-5xl">
        <div class="flex flex-col md:flex-row gap-8 w-full">
            <div class="w-full max-w-xs mx-auto rounded-lg overflow-hidden shadow-lg">
                ...
                <div class="bg-blue-500 h-48 flex items-center justify-center gap-20">
                    ...
                    <p class="text-white font-bold text-xl">{{ $documentCounts['Brgy Clearance'] ?? 0 }}</p>
                </div>
            </div>
            ...
            <div class="w-full max-w-xs mx-auto rounded-lg overflow-hidden shadow-lg">
                ...
                <div class="bg-blue-500 h-48 flex items-center justify-center gap-20">
                    <img src="{{ URL('images/sun.svg') }}" class="w-20" alt="">
                    <p class="text-white font-bold text-xl">{{ $documentCounts['Indigency'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row gap-8 w-full">
            <div class="w-full max-w-xs mx-auto rounded-lg overflow-hidden shadow-lg">
                ...
                <div class="bg-blue-500 h-48 flex items-center justify-center gap-20">
                    <img src="{{ URL('images/sun.svg') }}" class="w-20" alt="">
                    <p class="text-white font-bold text-xl">{{ $documentCounts['Residency'] ?? 0 }}</p>
                </div>
            </div>
            ...
            <div class="w-full max-w-xs mx-auto rounded-lg overflow-hidden shadow-lg">
                ...
                <div class="bg-blue-500 h-48 flex items-center justify-center gap-20">
                    <img src="{{ URL('images/sun.svg') }}" class="w-20" alt="">
                    <p class="text-white font-bold text-xl">{{ $documentCounts['Brgy Certificate'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="w-full max-w-xs mx-auto rounded-lg overflow-hidden shadow-lg md:col-span-2">
            ...
            <div class="bg-blue-500 h-48 flex items-center justify-center gap-20">
                <img src="{{ URL('images/sun.svg') }}" class="w-20" alt="">
                <p class="text-white font-bold text-xl">{{ $documentCounts['Oath Understanding'] ?? 0 }}</p>
            </div>
        </div>
    </div>
</div>
